...
const ProjectPreview = (props) => {
  return (
    ...
    <p>{projects[1].tech}</p>
    <a href="https://github.com/Primemerlinian/Beauty" className="buttonlink2"> Github </a>
    <a href="https://beauty-simulator.netlify.app/" className="buttonlink3"> Deployed app </a>
    </div>
    ...
    <p>{projects[2].tech}</p>
    <a href="https://github.com/Primemerlinian/Connect4" className="buttonlink2"> Github </a>
    <a href="https://mariah-lara-connect-4.netlify.app/" className="buttonlink3"> Deployed app </a>
    </div>
    ...
    <p>{projects[3].tech}</p>
    <a href="https://github.com/Primemerlinian/ttt-weekend.git" className="buttonlink2"> Github </a>
    <a href="https://pixel-toe-mariah-lara.netlify.app/" className="buttonlink3"> Deployed app </a>
    </div>
